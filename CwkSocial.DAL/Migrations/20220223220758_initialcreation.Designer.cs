...
namespace CwkSocial.DAL.Migrations
{
    ...
    [Migration("20220223220758_initialcreation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cwk.Domain.Aggregates.UseProfileAggregate.UserProfile", b =>
                {
                    b.Property<Guid>("UserProfileId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Cwk.Domain.Aggregates.PostAggregate.Post", b =>
                {
                    b.HasOne("Cwk.Domain.Aggregates.UseProfileAggregate.UserProfile", "UserProfile")
                        .WithMany()
            ...
            modelBuilder.Entity("Cwk.Domain.Aggregates.UseProfileAggregate.UserProfile", b =>
                {
                    b.OwnsOne("Cwk.Domain.Aggregates.UseProfileAggregate.BasicInfo", "BasicInfo", b1 =>
                        {
